...
def menu_relatorios(func, title):
    ...
    def salvar_valores(func):
        ...
        if func == "visualizacao_completa":
            ...
            planilhas_intranet(arquivo_selecionado.get())
...
def planilhas_intranet(file_path):
    """
    ...
    dados_organizados = {
        ...
        'Docente': sti['NUSP'],
        'Compartilhada com outra sala?': ["S" if ((sti['Sala'][i] == '6-305/6-306' or sti['Sala'][i] == '6-303/6-304') and sti['Inscritos'][i] > 30) else "N" for i in range(len(sti['Sala']))]
    }
