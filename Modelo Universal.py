...
if sys.argv[4]:
    print("String vazia tbm eh gente")
...
file_path = "Dados da solução do Modelo 4"
...
file_path1 = "Planilha do STI dada pelo Modelo 4"
...
for sala in sti_planilha['Sala'].unique():
    ...
    # print(len(df_aux))
    caminho_arquivo = f"Planilha do STI dada pelo Modelo 4 - {sala}"
...
# Por fim, salva o arquivo.
caminho_arquivo = f"Visualização completa - Modelo 4"
...
# Por fim, salva o arquivo.
caminho_arquivo = f"Visualização por curso - Modelo 4"
...
wb.remove(wb.active)
# Por fim, salvo o arquivo.
caminho_arquivo = f"Visualização por departamento - Modelo 4"
...
# Por fim, salvo o arquivo.
caminho_arquivo = f"Distribuição de Cursos - Modelo 4"
